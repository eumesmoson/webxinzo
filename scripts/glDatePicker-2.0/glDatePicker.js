	...
	var glDatePicker = (function() {
		...
		glDatePicker.prototype =
		{
			...
			render: function(renderCalback) {
				...
				var dowNames = options.dowNames || [ 'Lun', 'Mar', 'Mer', 'Xov', 'Ven', 'Sab', 'Dom' ];
				var monthNames = options.monthNames || [ 'Xaneiro', 'Febreiro', 'Marzo', 'Abril', 'Maio', 'Xuño', 'Xullo', 'Agosto', 'Septembro', 'Outubro', 'Novembro', 'Decembro' ];
					...
					for(var col = 0; col < maxCol; col++, cellIndex++) {
						...
						if(!row) {
							...
							if(!isSelectable ||
								...
								cellClass = ([ 'Lun', 'Mar', 'Mer', 'Xov', 'Ven', 'Sab', 'Dom' ])[cellDateVal.day];
